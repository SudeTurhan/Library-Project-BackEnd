# Generated by Django 3.2.3 on 2022-02-04 04:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('method', models.CharField(choices=[('Cash', 'Cash'), ('Credit Card', 'Credit Card')], default='Cash', max_length=20)),
                ...
                ('process', models.ForeignKey(limit_choices_to={'is_paid': False}, on_delete=django.db.models.deletion.CASCADE, to='api.rentlogs')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
